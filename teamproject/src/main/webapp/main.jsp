		...
		<div style="width:1000px;">
			...
			<table class="table1">
				...
				<tr>
					...
					<td><%=tel %></td>
					<%
					String sql2 = "SELECT COUNT(*) AS CNT FROM STOREREVIEW WHERE STID = '"+stid+"'";
					ResultSet rs2 = stmt2.executeQuery(sql2);
					rs2.next();
					String recnt = rs2.getString("CNT");
					%>
					<td><%=recnt %></td>
					<%
					String sql3 = "SELECT AVG(LEV) AS AVG FROM STOREREVIEW WHERE STID = '"+stid+"'";
					ResultSet rs3 = stmt3.executeQuery(sql3);
					rs3.next();
					String reavg = rs3.getString("AVG");
					if(reavg == null ){
						reavg = "0";
					}
					%>
